...
print("Getting the shrinked and dictionaried users and movie...")
import os
...
neighbors = [] # Store neighbor in this list
averages = [] # Each user's average rating
deviations = [] # Each user's deviation

print("Finding the neighbors, average and deviation...")
for i in range(N):
  movies_i = user2movie[i]
  movies_i_set = set(movies_i)
  # Caculating the average and deviation
